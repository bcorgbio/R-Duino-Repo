...
```{r, echo=FALSE, message = FALSE, fig.align ='center', fig.cap="Fig1: this is figure one"}
forewing.pca %>% 
  plot_PCA(title = "forewings")
```

```{r, echo=FALSE, message = FALSE, fig.align ='center', fig.cap="Fig2: this is figure two"}
hindwing.pca %>% 
...
```
# Our Evolutionary Rates Shown Below
```{r, include=True}
#to find evolutionary rates
...
```{r, echo=FALSE, message = FALSE, fig.align ='center', fig.cap="Fig5: this is figure three"}
